...
class PlayTracksInAlbumScreen extends StatefulWidget {
  int? positionTrack;
  ...
  @override
  State<PlayTracksInAlbumScreen> createState() =>
      _PlayTracksInAlbumScreenState();
}

class _PlayTracksInAlbumScreenState extends State<PlayTracksInAlbumScreen> {
  ...
  _musicInit(int positionSong) async {
    currentlySong = widget.listTracks[widget.positionTrack!].name;
    isPlaying = true;
  ...
  Widget build(BuildContext context) {
    ...
    if (currentlySong != widget.listTracks[widget.positionTrack!].name) {
      _musicInit(widget.positionTrack!);
    }
    return Miniplayer(
      elevation: 4,
